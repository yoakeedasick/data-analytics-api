...
export default function VerifyOTP() {
  ...
  const handleVerify = async e => {
    ...
    setSuccess('');
    try {
      await api.post('/auth/verify-otp', { email, otp_code: fullOtp });
  ...
  return (
    <div className="login-container">
      <div className="login-card">
        ...
        <p className="login-card-subtitle">Email Verification</p>
        ...
        <form onSubmit={handleVerify} className="login-card-form">
          ...
          <button type="submit" className="login-submit-btn" style={{ marginTop: '0.5rem' }} disabled={loading}>
